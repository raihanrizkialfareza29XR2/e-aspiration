...
function Navbar() {
  ...
  return (
    <div>
        <nav className="bg-red-600 dark:bg-red-700 border-gray-200 px-5 sm:px-26 py-4 fixed w-full z-10 shadow-lg">
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                ...
                <div className="hidden w-full md:block md:w-auto" id="mobile-menu">
                    <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-semibold">
                        ...
                        <li>
                            <Link to="/statistics" className="block py-2 pr-4 pl-3 text-white border-b border-gray-100 hover:bg-red-500 md:hover:bg-transparent md:border-0 md:hover:text-gray-300 md:p-0 md:dark:hover:text-white dark:hover:text-white md:dark:hover:bg-transparent">Statistik</Link>
                        </li>
                        <li>
